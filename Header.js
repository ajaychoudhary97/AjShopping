            ...
            >
              ...
              <Offcanvas.Body style={{justifyContent: 'flex-end'}}>
                <Nav md={6} sm={6}>
                  ...
                  <Nav.Link href="#action1" style={{marginRight: '273px;'}} className="me-2"> <Link to={"/cart"}><Image src="bag.png" style={{width: '23px'}}/>{count ? <span style={{border: '1px solid',borderRadius: '9px',fontSize:'17px',background:'red',color:'#fff'}}>{count}</span>: null}</Link></Nav.Link>
